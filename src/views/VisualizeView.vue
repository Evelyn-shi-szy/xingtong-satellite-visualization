...
.panel-heading {
  ...
  justify-content: space-between;
  padding: 17px 18px;
  border-bottom: 1px solid rgba(98, 243, 255, .1);
}
...
.satellite-switcher button:hover,
.satellite-switcher button.active {
  border-color: rgba(98, 243, 255, .35);
  background: rgba(13, 43, 62, .72);
}
...
.satellite-switcher button.active .switcher-arrow {
  color: #62f3ff;
}
...
.state-dot {
  ...
  border-radius: 50%;
  background: #e2b75d;
  box-shadow: 0 0 10px rgba(226, 183, 93, .65);
}

.state-dot.ready {
  background: #53efa1;
  box-shadow: 0 0 10px rgba(83, 239, 161, .65);
}

.state-dot.error {
  background: #ff6e7f;
  box-shadow: 0 0 10px rgba(255, 110, 127, .65);
}
...
.loader-ring {
  width: 34px;
  height: 34px;
  border: 2px solid rgba(98, 243, 255, .18);
  border-top-color: #62f3ff;
  border-radius: 50%;
